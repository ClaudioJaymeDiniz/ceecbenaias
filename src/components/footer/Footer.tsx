...
import imgLogo from '../../assets/images/logo-2.jpg';



export default function Footer() {
    return (
      <div className="mt-8 bg-vermelho pt-9">
      <div className="mx-auto w-full max-w-[1166px] px-4 xl:px-0">
        <div className="flex flex-col justify-between sm:px-[18px] md:flex-row md:px-10">
          <div className="md:w-[316px]">
            <p className="text-[18px] font-medium text-white">
              <img className='rounded-full w-32 m-auto' src={imgLogo} alt="" />
            ...
            <div className="mt-[18px] flex gap-4 justify-center">
            
              <a className="hover:scale-110" target="blank"
                href="https://wa.me/551296520850?text=Olá,%20vi%20o%20seu%20site%20e%20quero%20mais%20informações">
                  <img className='w-9 h-9' alt="whatsapp icon" 
              ...
              <a className="hover:scale-110" target="_blank"
                href="https://www.instagram.com/centrotreinamentobenaias?igsh=MXE4cXVocmJ5czZjaQ== ">
                  <img className='w-9 h-9' alt="linkdin icon" 
                    loading="lazy"  decoding="async" data-nimg="1" 
                    src={imgInsta} />
              </a>
              ...
              <a className="hover:scale-110" target="_blank"
                href="https://www.facebook.com/centrotreinamentobenaias">
                  <img className='w-9 h-9' alt="instagram icon" 
                    loading="lazy"  decoding="async" data-nimg="1" 
                    src={imgFace} />
              </a>
              ...
              <a className="hover:scale-110" target="_blank"
                href="https://www.tiktok.com/@ceecbenaias?_t=ZM-8t5dVMPOziQ&_r=1">
                  <img className='w-9 h-9' alt="twitter icon" 
                    loading="lazy" decoding="async" data-nimg="1" 
                    src={imgTik} />
              </a>
              <a className="hover:scale-110" target="_blank"
                href="https://www.youtube.com/@rafaelreis1227">
                  <img className='w-9 h-9' alt="youtube icon" loading="lazy" decoding="async" data-nimg="1" 
                  src={imgYoutube} />
              </a>
          ...
          <div className="md:w-[316px]">
            <div className="mt-[23px] flex">
              ...
              <div className="ml-[18px]">
                <a href="tel:+911800123444" className="font-Inter text-[14px] font-medium text-white">+55 1296520850</a>
                <p className="font-Inter text-[12px] font-medium text-white">Rafael Reis</p>
              </div>
            </div>
            <div className="mt-[23px] flex">
              <div className="flex h-[38px] w-[38px] items-center justify-center rounded-[75%]">
              ...
              <div className="ml-[18px]">
                <a href="mailto:help@lorem.com" className="font-Inter text-[14px] font-medium text-[#fff]">gestao.rafael@cecbenaias.com.br</a>
                <p className="font-Inter text-[12px] font-medium text-[#fff]">Nosso Email</p>
              </div>
            </div>
            <div className="mt-[23px] flex">
              <div className="flex h-[38px] w-[38px] items-center justify-center rounded-[75%]">
              ...
              <div className="ml-[18px]">
                <a href="https://maps.app.goo.gl/qh5ZcjDQCdsuqPeH7" className="font-Inter text-[14px] font-medium text-[#fff]">Av. Barbacena, 282, Sala 1, Vila Industrial
                  , 12221-000</a>
                <p className="font-Inter text-[12px] font-medium text-white">Endereço</p>
              </div>
            </div>
          </div>
        ...
        <div className="flex items-center justify-center pb-8 pt-[9px] md:py-8">
          <p className="text-[10px] font-normal text-white md:text-[12px]">
            © Copyright
            2025
            , All Rights Reserved by CEEC BENAIAS
          </p>
        </div>
      </div>
    </div>
